...
abstract class DictionaryGeneratorConfig {
     ...
     */
    @get:Input
    abstract var createConfigFile: Boolean
     ...
     */
    @get:Input
    abstract var fieldMethodObfuscationStrategy: ObfuscationStrategy
     ...
     */
    @get:Input
    abstract var classObfuscationStrategy: ObfuscationStrategy
     ...
     */
    @get:Input
    abstract var packageObfuscationStrategy: ObfuscationStrategy
    ...
    @get:Input
    @get:Optional
    abstract var variantNameFilter: String?
}